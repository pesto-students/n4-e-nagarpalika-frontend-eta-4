...
import {Header, SVGIMAGE, ActionButton, H1, P, HeaderMin} from "./styles";

const LandingPageNew = () =>
    <Header className="container-fluid">
        <Header className="container">

            <HeaderMin className="container-xl row">
            ...
            <P>
                e-Nagarpalika re-imagines the way we file our grievances. You have a voice, and it needs to be heard.
                File your grievances and get a hasslefree resolution.
            </P>

            <ActionButton type="button">Register</ActionButton>
                </div>
            </HeaderMin>
        </Header>
    </Header>
